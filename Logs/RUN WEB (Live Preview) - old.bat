...
echo =============================================
echo.
echo Starting static web preview...
echo Open http://localhost:8080 in Chrome when the server is ready.
echo.
echo REFRESH     : Run "flutter build web", then refresh the browser
echo QUIT        : Press q then Enter in this window
echo.
...
>> "%LOGFILE%" echo =============================================
>> "%LOGFILE%" echo.
>> "%LOGFILE%" echo Starting static web preview...
...
>> "%LOGFILE%" echo [1/4] Skipping flutter clean to keep build/web.
