...
BLANK_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'English', 'Characters', 'BLANK.png')
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'z NEWLY CREATED')
