...
final Map<String, List<String>> boardFolderHints = {
  ...
  'habitats': ['1. main boards/animals & habitats/habitats'],
  ...
  'food & drink': ['1. main boards/cooking & food', '3. lesson vocab/cooking & food'],
  'home & household': ['1. main boards/places/rooms & home'],
  'school & instructions': ['1. main boards/people at school', 'boards/people at school'],
  'descriptions & attributes': ['1. main boards/adjectives', 'boards/english/adjectives'],
  'outside': ['1. main boards/places', 'boards/town'],
  'time & days': ['1. main boards/time', 'boards/time'],
  'questions': ['1. main boards/adverbs', 'boards/english/how'],
  'personal actions': ['1. main boards/actions'],
  'shared activities': ['1. main boards/people & places'],
  'leisure activities & interests': ['1. main boards/sports, activities & p.e'],
  'general objects': ['1. main boards/furniture'],
  'clothing & personal': ['1. main boards/clothes'],
  'personal possessions': ['1. main boards/toys'],
  'personal hygiene': ['1. main boards/body parts', 'boards/medical'],
  'gender & sexuality': ['1. main boards/people'],
  'sport': ['1. main boards/sports, activities & p.e'],
  'religion & customs': ['1. main boards/time/events & occasions'],
  ...
  'quantity & measurement': ['1. main boards/numbers'],
