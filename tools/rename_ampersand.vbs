...
Set logFile = fso.CreateTextFile(fso.BuildPath(base, "rename_ampersand.log"), True)
...
logFile.WriteLine "Starting rename of ' & ' items in " & base
RenameFolder fso.GetFolder(base)
logFile.WriteLine "Done."
logFile.Close
WScript.Echo "Done. See rename_ampersand.log for details."
